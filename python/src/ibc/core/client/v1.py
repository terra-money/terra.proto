...
# sources: ibc/core/client/v1/client.proto, ibc/core/client/v1/genesis.proto, ibc/core/client/v1/tx.proto, ibc/core/client/v1/query.proto
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def update_client(
        ...
        *,
        client_id: str = "",
        header: Optional[protobuf.Any] = None,
        signer: str = "",
