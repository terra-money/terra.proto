...
class MsgSubmitMisbehaviour(betterproto.Message):
    ...
    light client misbehaviour. Warning: DEPRECATED
    """
    ...
    def __post_init__(self) -> None:
        ...
        if self.is_set("client_id"):
            warnings.warn(
                "MsgSubmitMisbehaviour.client_id is deprecated", DeprecationWarning
            )
        if self.is_set("misbehaviour"):
            warnings.warn(
                "MsgSubmitMisbehaviour.misbehaviour is deprecated", DeprecationWarning
            )
        if self.is_set("signer"):
            warnings.warn(
                "MsgSubmitMisbehaviour.signer is deprecated", DeprecationWarning
            )
