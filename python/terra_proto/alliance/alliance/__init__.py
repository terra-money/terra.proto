...
# sources: alliance/alliance.proto, alliance/delegations.proto, alliance/events.proto, alliance/genesis.proto, alliance/gov.proto, alliance/params.proto, alliance/query.proto, alliance/tx.proto
...
class QueryBase(ServiceBase):
    ...
    async def ibc_alliance(self) -> "QueryAllianceResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def ibc_alliance_delegation(self) -> "QueryAllianceDelegationResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
