...
public object QueryGrpcKt {
  ...
  public val granterGrantsMethod:
  ...
  public class QueryCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun granterGrants(request: QueryOuterClass.QueryGranterGrantsRequest,
        headers: Metadata = Metadata()): QueryOuterClass.QueryGranterGrantsResponse = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun granteeGrants(request: QueryOuterClass.QueryGranteeGrantsRequest,
        headers: Metadata = Metadata()): QueryOuterClass.QueryGranteeGrantsResponse = unaryRpc(
      channel,
  ...
  public abstract class QueryCoroutineImplBase(
     ...
     * @param request The request from the client.
     */
    public open suspend fun granterGrants(request: QueryOuterClass.QueryGranterGrantsRequest):
    ...
    /**
     * Returns the response to an RPC for cosmos.authz.v1beta1.Query.GranteeGrants.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun granteeGrants(request: QueryOuterClass.QueryGranteeGrantsRequest):
        QueryOuterClass.QueryGranteeGrantsResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.authz.v1beta1.Query.GranteeGrants is unimplemented"))
