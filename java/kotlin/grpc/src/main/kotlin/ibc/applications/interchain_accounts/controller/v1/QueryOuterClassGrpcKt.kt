...
import ibc.applications.interchain_accounts.controller.v1.QueryGrpc.getServiceDescriptor
...
public object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) ibc.applications.interchain_accounts.controller.v1.Query
  ...
  /**
   * Skeletal implementation of the ibc.applications.interchain_accounts.controller.v1.Query service
  ...
  public abstract class QueryCoroutineImplBase(
    ...
    public open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method ibc.applications.interchain_accounts.controller.v1.Query.Params is unimplemented"))
