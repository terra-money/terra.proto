...
import ibc.applications.interchain_accounts.host.v1.QueryGrpc.getServiceDescriptor
...
public object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) ibc.applications.interchain_accounts.host.v1.Query service as
  ...
  /**
   * Skeletal implementation of the ibc.applications.interchain_accounts.host.v1.Query service based
  ...
  public abstract class QueryCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for ibc.applications.interchain_accounts.host.v1.Query.Params.
     *
    ...
    public open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method ibc.applications.interchain_accounts.host.v1.Query.Params is unimplemented"))
