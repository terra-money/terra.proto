...
inline fun header(block: ibc.lightclients.solomachine.v1.HeaderKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v1.Solomachine.Header =
...
object HeaderKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: ibc.lightclients.solomachine.v1.Solomachine.Header.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun ibc.lightclients.solomachine.v1.Solomachine.Header.copy(block: ibc.lightclients.solomachine.v1.HeaderKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v1.Solomachine.Header =
