...
inline fun consensusState(block: ibc.lightclients.solomachine.v2.ConsensusStateKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v2.Solomachine.ConsensusState =
...
object ConsensusStateKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: ibc.lightclients.solomachine.v2.Solomachine.ConsensusState.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun ibc.lightclients.solomachine.v2.Solomachine.ConsensusState.copy(block: ibc.lightclients.solomachine.v2.ConsensusStateKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v2.Solomachine.ConsensusState =
