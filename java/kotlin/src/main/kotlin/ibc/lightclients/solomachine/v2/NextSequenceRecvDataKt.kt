...
inline fun nextSequenceRecvData(block: ibc.lightclients.solomachine.v2.NextSequenceRecvDataKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v2.Solomachine.NextSequenceRecvData =
...
object NextSequenceRecvDataKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: ibc.lightclients.solomachine.v2.Solomachine.NextSequenceRecvData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun ibc.lightclients.solomachine.v2.Solomachine.NextSequenceRecvData.copy(block: ibc.lightclients.solomachine.v2.NextSequenceRecvDataKt.Dsl.() -> Unit): ibc.lightclients.solomachine.v2.Solomachine.NextSequenceRecvData =
