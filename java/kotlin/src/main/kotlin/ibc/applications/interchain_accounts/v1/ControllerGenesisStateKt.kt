...
public inline fun controllerGenesisState(block: ibc.applications.interchain_accounts.v1.ControllerGenesisStateKt.Dsl.() -> kotlin.Unit): ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState =
  ibc.applications.interchain_accounts.v1.ControllerGenesisStateKt.Dsl._create(ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState.newBuilder()).apply { block() }._build()
public object ControllerGenesisStateKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState.copy(block: ibc.applications.interchain_accounts.v1.ControllerGenesisStateKt.Dsl.() -> kotlin.Unit): ibc.applications.interchain_accounts.v1.Genesis.ControllerGenesisState =
  ibc.applications.interchain_accounts.v1.ControllerGenesisStateKt.Dsl._create(this.toBuilder()).apply { block() }._build()
