...
public inline fun unpinCodesProposal(block: cosmwasm.wasm.v1.UnpinCodesProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.UnpinCodesProposal =
  cosmwasm.wasm.v1.UnpinCodesProposalKt.Dsl._create(cosmwasm.wasm.v1.Proposal.UnpinCodesProposal.newBuilder()).apply { block() }._build()
public object UnpinCodesProposalKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmwasm.wasm.v1.Proposal.UnpinCodesProposal.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmwasm.wasm.v1.Proposal.UnpinCodesProposal.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmwasm.wasm.v1.Proposal.UnpinCodesProposal = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmwasm.wasm.v1.Proposal.UnpinCodesProposal.copy(block: cosmwasm.wasm.v1.UnpinCodesProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.UnpinCodesProposal =
