...
public inline fun instantiateContractProposal(block: cosmwasm.wasm.v1.InstantiateContractProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.InstantiateContractProposal =
  cosmwasm.wasm.v1.InstantiateContractProposalKt.Dsl._create(cosmwasm.wasm.v1.Proposal.InstantiateContractProposal.newBuilder()).apply { block() }._build()
public object InstantiateContractProposalKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmwasm.wasm.v1.Proposal.InstantiateContractProposal.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmwasm.wasm.v1.Proposal.InstantiateContractProposal.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmwasm.wasm.v1.Proposal.InstantiateContractProposal = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmwasm.wasm.v1.Proposal.InstantiateContractProposal.copy(block: cosmwasm.wasm.v1.InstantiateContractProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.InstantiateContractProposal =
