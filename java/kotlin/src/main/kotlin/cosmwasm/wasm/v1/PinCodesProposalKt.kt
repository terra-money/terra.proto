...
public inline fun pinCodesProposal(block: cosmwasm.wasm.v1.PinCodesProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.PinCodesProposal =
  cosmwasm.wasm.v1.PinCodesProposalKt.Dsl._create(cosmwasm.wasm.v1.Proposal.PinCodesProposal.newBuilder()).apply { block() }._build()
public object PinCodesProposalKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmwasm.wasm.v1.Proposal.PinCodesProposal.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmwasm.wasm.v1.Proposal.PinCodesProposal.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmwasm.wasm.v1.Proposal.PinCodesProposal = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmwasm.wasm.v1.Proposal.PinCodesProposal.copy(block: cosmwasm.wasm.v1.PinCodesProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.Proposal.PinCodesProposal =
