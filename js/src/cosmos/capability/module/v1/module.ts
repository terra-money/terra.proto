...
export const Module = {
  ...
  fromJSON(object: any): Module {
    const message = { ...baseModule } as Module;
    if (object.sealKeeper !== undefined && object.sealKeeper !== null) {
      message.sealKeeper = Boolean(object.sealKeeper);
    } else {
      message.sealKeeper = false;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<Module>): Module {
    const message = { ...baseModule } as Module;
    if (object.sealKeeper !== undefined && object.sealKeeper !== null) {
      message.sealKeeper = object.sealKeeper;
    } else {
      message.sealKeeper = false;
    }
    return message;
