...
export class ListAllInterfacesResponse extends jspb.Message {
  ...
  static toObject(
    ...
    msg: ListAllInterfacesResponse,
  ): ListAllInterfacesResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class ListImplementationsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListImplementationsRequest,
  ): ListImplementationsRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class ListImplementationsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListImplementationsResponse,
  ): ListImplementationsResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
