...
export class GetValidatorSetByHeightRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: GetValidatorSetByHeightRequest,
  ): GetValidatorSetByHeightRequest.AsObject;
...
export class GetValidatorSetByHeightResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetValidatorSetByHeightResponse,
  ): GetValidatorSetByHeightResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class GetLatestValidatorSetRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetLatestValidatorSetRequest,
  ): GetLatestValidatorSetRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class GetLatestValidatorSetResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetLatestValidatorSetResponse,
  ): GetLatestValidatorSetResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
