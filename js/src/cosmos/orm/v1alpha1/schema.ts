...
export const ModuleSchemaDescriptor = {
  ...
  fromJSON(object: any): ModuleSchemaDescriptor {
    ...
    if (object.schemaFile !== undefined && object.schemaFile !== null) {
      for (const e of object.schemaFile) {
        message.schemaFile.push(ModuleSchemaDescriptor_FileEntry.fromJSON(e));
      }
    }
  ...
  fromPartial(object: DeepPartial<ModuleSchemaDescriptor>): ModuleSchemaDescriptor {
    ...
    if (object.schemaFile !== undefined && object.schemaFile !== null) {
      for (const e of object.schemaFile) {
        message.schemaFile.push(ModuleSchemaDescriptor_FileEntry.fromPartial(e));
      }
    }
    if (object.prefix !== undefined && object.prefix !== null) {
...
const baseModuleSchemaDescriptor_FileEntry: object = { id: 0, protoFileName: "", storageType: 0 };
...
export const ModuleSchemaDescriptor_FileEntry = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ModuleSchemaDescriptor_FileEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseModuleSchemaDescriptor_FileEntry } as ModuleSchemaDescriptor_FileEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
