...
export class QueryProposalsRequest extends jspb.Message {
  ...
  setProposalStatus(
    value: cosmos_gov_v1beta1_gov_pb.ProposalStatusMap[keyof cosmos_gov_v1beta1_gov_pb.ProposalStatusMap],
  ): void;
...
export class QueryProposalsResponse extends jspb.Message {
  ...
  addProposals(
    value?: cosmos_gov_v1beta1_gov_pb.Proposal,
    index?: number,
  ): cosmos_gov_v1beta1_gov_pb.Proposal;
