...
export class QueryDenomsMetadataRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: QueryDenomsMetadataRequest,
  ): QueryDenomsMetadataRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryDenomsMetadataResponse extends jspb.Message {
  ...
  addMetadatas(
    value?: cosmos_bank_v1beta1_bank_pb.Metadata,
    index?: number,
  ): cosmos_bank_v1beta1_bank_pb.Metadata;
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDenomsMetadataResponse,
  ): QueryDenomsMetadataResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryDenomMetadataRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDenomMetadataRequest,
  ): QueryDenomMetadataRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryDenomMetadataResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDenomMetadataResponse,
  ): QueryDenomMetadataResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
