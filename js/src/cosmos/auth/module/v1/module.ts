...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    if (object.moduleAccountPermissions !== undefined && object.moduleAccountPermissions !== null) {
      for (const e of object.moduleAccountPermissions) {
        message.moduleAccountPermissions.push(ModuleAccountPermission.fromJSON(e));
      }
    }
  ...
  fromPartial(object: DeepPartial<Module>): Module {
    ...
    if (object.moduleAccountPermissions !== undefined && object.moduleAccountPermissions !== null) {
      for (const e of object.moduleAccountPermissions) {
        message.moduleAccountPermissions.push(ModuleAccountPermission.fromPartial(e));
      }
    }
    if (object.authority !== undefined && object.authority !== null) {
...
export const ModuleAccountPermission = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ModuleAccountPermission {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseModuleAccountPermission } as ModuleAccountPermission;
    message.permissions = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
