...
export class QueryModuleVersionsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryModuleVersionsRequest,
  ): QueryModuleVersionsRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryModuleVersionsResponse extends jspb.Message {
  ...
  addModuleVersions(
    value?: cosmos_upgrade_v1beta1_upgrade_pb.ModuleVersion,
    index?: number,
  ): cosmos_upgrade_v1beta1_upgrade_pb.ModuleVersion;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryModuleVersionsResponse.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: QueryModuleVersionsResponse,
  ): QueryModuleVersionsResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
