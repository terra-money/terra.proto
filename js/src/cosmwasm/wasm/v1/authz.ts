...
export const ContractExecutionAuthorization = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ContractExecutionAuthorization {
    ...
    const message = { ...baseContractExecutionAuthorization } as ContractExecutionAuthorization;
    message.grants = [];
...
export const ContractMigrationAuthorization = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ContractMigrationAuthorization {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseContractMigrationAuthorization } as ContractMigrationAuthorization;
    message.grants = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
const baseMaxCallsLimit: object = { remaining: Long.UZERO };
...
export const MaxCallsLimit = {
  ...
  fromJSON(object: any): MaxCallsLimit {
    ...
    if (object.remaining !== undefined && object.remaining !== null) {
      message.remaining = Long.fromString(object.remaining);
    } else {
      message.remaining = Long.UZERO;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<MaxCallsLimit>): MaxCallsLimit {
    const message = { ...baseMaxCallsLimit } as MaxCallsLimit;
    if (object.remaining !== undefined && object.remaining !== null) {
      message.remaining = object.remaining as Long;
    } else {
      message.remaining = Long.UZERO;
    }
    return message;
...
const baseCombinedLimit: object = { callsRemaining: Long.UZERO };
...
export const CombinedLimit = {
  ...
  fromJSON(object: any): CombinedLimit {
    ...
    if (object.callsRemaining !== undefined && object.callsRemaining !== null) {
      message.callsRemaining = Long.fromString(object.callsRemaining);
    } else {
      message.callsRemaining = Long.UZERO;
    }
    if (object.amounts !== undefined && object.amounts !== null) {
      for (const e of object.amounts) {
        message.amounts.push(Coin.fromJSON(e));
  ...
  fromPartial(object: DeepPartial<CombinedLimit>): CombinedLimit {
    ...
    message.amounts = [];
    if (object.callsRemaining !== undefined && object.callsRemaining !== null) {
      message.callsRemaining = object.callsRemaining as Long;
    } else {
      message.callsRemaining = Long.UZERO;
    }
    if (object.amounts !== undefined && object.amounts !== null) {
...
export const AcceptedMessageKeysFilter = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AcceptedMessageKeysFilter {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseAcceptedMessageKeysFilter } as AcceptedMessageKeysFilter;
    message.keys = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
