...
const baseDelegateAllianceEvent: object = { allianceSender: "", validator: "", newShares: "" };
...
const baseUndelegateAllianceEvent: object = { allianceSender: "", validator: "" };
...
export const UndelegateAllianceEvent = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UndelegateAllianceEvent {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseUndelegateAllianceEvent } as UndelegateAllianceEvent;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const RedelegateAllianceEvent = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedelegateAllianceEvent {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseRedelegateAllianceEvent } as RedelegateAllianceEvent;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
const baseClaimAllianceRewardsEvent: object = { allianceSender: "", validator: "" };
...
export const ClaimAllianceRewardsEvent = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClaimAllianceRewardsEvent {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseClaimAllianceRewardsEvent } as ClaimAllianceRewardsEvent;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const DeductAllianceAssetsEvent = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeductAllianceAssetsEvent {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseDeductAllianceAssetsEvent } as DeductAllianceAssetsEvent;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
