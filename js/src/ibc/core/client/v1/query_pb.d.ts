...
export class QueryClientStatusResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryClientStatusResponse,
  ): QueryClientStatusResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryUpgradedClientStateRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryUpgradedClientStateRequest,
  ): QueryUpgradedClientStateRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class QueryUpgradedClientStateResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryUpgradedClientStateResponse,
  ): QueryUpgradedClientStateResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
