...
export class MsgConnectionOpenInitResponse extends jspb.Message {
  ...
  static toObject(
    ...
    msg: MsgConnectionOpenInitResponse,
  ): MsgConnectionOpenInitResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class MsgConnectionOpenTry extends jspb.Message {
  ...
  addCounterpartyVersions(
    value?: ibc_core_connection_v1_connection_pb.Version,
    index?: number,
  ): ibc_core_connection_v1_connection_pb.Version;
...
export class MsgConnectionOpenTryResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgConnectionOpenTryResponse,
  ): MsgConnectionOpenTryResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class MsgConnectionOpenAckResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgConnectionOpenAckResponse,
  ): MsgConnectionOpenAckResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class MsgConnectionOpenConfirmResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgConnectionOpenConfirmResponse,
  ): MsgConnectionOpenConfirmResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
